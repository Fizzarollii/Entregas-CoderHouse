...
namespace NicolasCanavese.Modelos
{
    internal class _Usuarios
    {
        ...
        public _Usuarios(int id, string nombre, string apellido, string nombreUsuario, string password, string email) : this(nombre, apellido, nombreUsuario, password, email)
        {
            this.id = id;
